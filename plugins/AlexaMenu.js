...
if (Config.WORKTYPE == 'private') {
    ...
    WhatsAlexa.addCommand({pattern: 'menu ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'*● WhatsAlexa ●*\n\n' + CMD_HELP, MessageType.text,{quoted: message.data, contextInfo: { forwardingScore: 9, isForwarded: true }}
            );
        }
    }));
}
    ...
    WhatsAlexa.addCommand({pattern: 'menu ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
