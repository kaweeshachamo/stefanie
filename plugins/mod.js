//https://gist.githubusercontent.com/MrChaby/89b355c8613d000cb69d7b77215335ea/raw/77a518f91271e1226ab8a2d616b006e47f08adb6/modproduct.js
...
const D_S = "Mod apps links"
let WK = Config.WORKTYPE == 'public' ? false : true

//product msg
WhatsAlexa.addCommand({pattern: 'mod', fromMe: WK, deleteCommand: false, desc: D_S,}, (async (message, match) => {

await message.client.sendMessage(message.jid,MOD, MessageType.text, key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./src/image/WhatsAlexa.png`)},"title": `Mod Store\n${pushname}`,"description": "Ms Jessica Team", "currencyCode": "LKR","priceAmount1000": "9999999999","retailerId": "WhatsAlexa","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}});
...
WhatsAlexa.addCommand({pattern: 'mod', fromMe: true, deleteCommand: false, desc: D_S,}, (async (message, match) => {

await message.client.sendMessage(message.jid,MOD, MessageType.text);
