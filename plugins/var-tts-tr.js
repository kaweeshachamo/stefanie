...
if (config.WORKTYPE == 'private') {
    ...
    Stefanie.addCommand({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: true}, (async (message, match) => {
    ...
    Stefanie.addCommand({ pattern: 'get ?(.*)', fromMe: true, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Stefanie.addCommand({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: false}, (async (message, match) => {
    ...
    Stefanie.addCommand({ pattern: 'get ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
