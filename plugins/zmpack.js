...
const Ln = "*ꜱᴛᴇꜰᴀɴɪᴇ ᴍᴇᴍᴇ ᴘᴀᴄᴋ ꜰᴏʀ ꜰᴜɴ* "
...
let td = Config.WORKTYPE == 'public' ? false : true
    ...
    Asena.addCommand({ pattern: 'my3 ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: Config.CAPTION_NAME})
